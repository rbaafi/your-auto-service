...
/**
 * An activity representing a single Vehicle detail screen. This activity is only used on narrow
 * width devices. On tablet-size devices, item details are presented side-by-side with a list of
 * items in a {@link VehicleListActivity}.
 */
public class VehicleDetailActivity extends AppCompatActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == android.R.id.home) {
      ...
      //
      navigateUpTo(new Intent(this, VehicleListActivity.class));
      return true;
    }
